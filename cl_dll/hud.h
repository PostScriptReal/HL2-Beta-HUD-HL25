...
#define RGB_YELLOWISH 0x00FFD040 //255,208,64
...
public:
	...
	wrect_t *m_prcDigitsBG1;
	HSPRITE m_hDigitsBG2;
	wrect_t *m_prcDigitsBG2;
	HSPRITE m_hDigitsSmBG1;
	wrect_t *m_prcDigitsSmBG1;
	HSPRITE m_hDigitsSmBG2;
	wrect_t *m_prcDigitsSmBG2;
